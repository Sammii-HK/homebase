...
export const LAUNCH_PRODUCTS: LaunchProduct[] = [
  ...
  },
  {
    ...
    status: "not-started",
    milestones: [
      { label: "Design tarot journal", done: false },
      { label: "Build template", done: false },
      { label: "Gumroad listing", done: false },
      { label: "Launch post", done: false },
    ],
    nextAction: "Design tarot journal template",
  ...
  },
  {
    ...
    status: "not-started",
    milestones: [
      { label: "Identify tool to package", done: false },
      { label: "Build standalone tool", done: false },
      { label: "Landing page", done: false },
      { label: "Launch on Product Hunt", done: false },
    ],
    nextAction: "Identify first dev tool to package",
    keyMetric: { label: "Users", source: "manual" },
    pricingNote: "Freemium",
  },
  {
    id: "prism-components",
